...
public class Restaurant {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(" --------isVegetarian printed the Entrees ----------------");
        menu.stream()
                .filter(Entree::isVegetarian) // p->p.isVegetarian
                .forEach(System.out::println);

        System.out.println(" --------isVegetarian -count theEntrees ----------------");
        menu.stream()
                .filter(Entree::isVegetarian) // p->p.isVegetarian
                .count();
        ...
        System.out.println(" sort the entrees by calories (highest to lowest) and remove the biggest 2," +
                " what are the names of the remaining entrees ----------------");
        menu.stream()
